...
class MockDataService {
  ...
  // Consumer Catalog Products (Swiggy / Blinkit / Zomato Instamart Style)
  static final List<ConsumerProduct> consumerProducts = [
    ...
    const ConsumerProduct(
      id: 'c_prod_02',
      name: 'Organic Hill Potatoes (Jyoti)',
      category: 'Vegetables',
      pricePerKg: 24.0,
      mrpPrice: 32.0,
      unit: '1 kg',
      availableQuantityKg: 220.0,
    ...
    const ConsumerProduct(
      ...
      harvestFreshness: 'Sweet & Crunchy',
    ),
    const ConsumerProduct(
      id: 'c_prod_05',
      ...
      source: 'Direct from Shabad Cluster',
      distanceKm: 6.2,
      qualityGrade: 'Grade A',
      iconEmoji: '🫑',
      rating: 4.8,
      ratingCount: 112,
      deliveryTime: '20-25 mins',
      harvestFreshness: 'Crunchy Fresh',
    ),
    const ConsumerProduct(
      id: 'c_prod_06',
      ...
      source: 'Direct from Hydroponic Farm',
      distanceKm: 4.8,
      ...
      ratingCount: 89,
      deliveryTime: '20-25 mins',
      harvestFreshness: 'Zero Pesticides',
    ),
    const ConsumerProduct(
      id: 'c_prod_07',
      ...
      ratingCount: 76,
      deliveryTime: '15-20 mins',
      harvestFreshness: 'Glossy & Tender',
    ),
    const ConsumerProduct(
      id: 'c_prod_08',
      name: 'Crisp Green Cucumber (Kheera)',
      category: 'Vegetables',
      pricePerKg: 16.0,
      mrpPrice: 24.0,
      unit: '500 g',
      availableQuantityKg: 110.0,
      source: 'Direct from FPO Center',
      distanceKm: 3.2,
      qualityGrade: 'Grade A',
      iconEmoji: '🥒',
      rating: 4.8,
      ratingCount: 142,
      deliveryTime: '15-20 mins',
      harvestFreshness: 'Hydrating Fresh',
    ),
    const ConsumerProduct(
      id: 'c_prod_09',
      ...
      source: 'Direct from Shamshabad Farm',
      distanceKm: 5.8,
      qualityGrade: 'Grade A',
      iconEmoji: '🌽',
      rating: 4.9,
      ratingCount: 153,
      deliveryTime: '20-25 mins',
      harvestFreshness: 'Juicy Kernels',
    ),
    const ConsumerProduct(
      id: 'c_prod_10',
      ...
      source: 'Direct from Cluster Hub',
      distanceKm: 4.0,
      qualityGrade: 'Grade A',
      iconEmoji: '🫛',
      rating: 4.7,
      ratingCount: 95,
      deliveryTime: '15-20 mins',
      harvestFreshness: 'Sweet Pods',
    ),
    const ConsumerProduct(
      id: 'c_prod_11',
      name: 'Garlic & Ginger Cooking Duo',
      category: 'Vegetables',
      pricePerKg: 28.0,
      mrpPrice: 40.0,
      unit: '250 g',
      ...
      ratingCount: 180,
      deliveryTime: '15-20 mins',
      harvestFreshness: 'Aromatic & Fresh',
    ),
    const ConsumerProduct(
      id: 'c_prod_12',
      name: 'Spicy Green Chillies (Mirchi)',
      category: 'Vegetables',
      pricePerKg: 10.0,
      mrpPrice: 16.0,
      unit: '100 g',
    ...
    const ConsumerProduct(
      ...
      unit: '4 pcs',
      availableQuantityKg: 150.0,
      source: 'Direct from Citrus Orchard',
      distanceKm: 4.5,
      qualityGrade: 'Grade A',
      iconEmoji: '🍋',
      rating: 4.8,
      ratingCount: 210,
      deliveryTime: '15-20 mins',
      harvestFreshness: 'High Juice Content',
    ),
    ...
    const ConsumerProduct(
      id: 'c_prod_15',
      name: 'Aromatic Fresh Coriander (Dhaniya)',
      category: 'Greens',
      pricePerKg: 8.0,
      mrpPrice: 14.0,
      unit: '1 bunch (100g)',
      ...
      deliveryTime: '15-20 mins',
      isBestseller: true,
      harvestFreshness: 'Super Aromatic',
    ),
    const ConsumerProduct(
      id: 'c_prod_16',
      ...
      ratingCount: 140,
      deliveryTime: '15-20 mins',
      harvestFreshness: 'Refreshing Aroma',
    ),
    const ConsumerProduct(
      id: 'c_prod_17',
    ...
    const ConsumerProduct(
      ...
      source: 'Direct from Orchard Co-op',
      distanceKm: 4.5,
      qualityGrade: 'Naturally Ripened',
      iconEmoji: '🍌',
      rating: 4.9,
      ratingCount: 310,
      deliveryTime: '15-20 mins',
      isBestseller: true,
      harvestFreshness: 'Naturally Sweet',
    ),
    const ConsumerProduct(
      id: 'c_prod_19',
      ...
      unit: '500 g (~3 pcs)',
      availableQuantityKg: 60.0,
      source: 'Direct from Himalayan FPO',
      distanceKm: 5.2,
      qualityGrade: 'Grade A',
      iconEmoji: '🍎',
      rating: 4.9,
      ratingCount: 220,
      deliveryTime: '15-20 mins',
      harvestFreshness: 'Crisp & Juicy',
    ),
    const ConsumerProduct(
      id: 'c_prod_20',
      name: 'Sweet Nagpur Oranges (Santra)',
      category: 'Fruits',
      pricePerKg: 55.0,
      mrpPrice: 72.0,
      unit: '1 kg',
      availableQuantityKg: 80.0,
      source: 'Direct from Maharashtra FPO',
      distanceKm: 5.0,
      qualityGrade: 'Grade A',
      iconEmoji: '🍊',
      rating: 4.8,
      ratingCount: 165,
      deliveryTime: '20-25 mins',
      harvestFreshness: 'Rich in Vitamin C',
    ),
    const ConsumerProduct(
      id: 'c_prod_21',
      name: 'Juicy Striped Watermelon',
      category: 'Fruits',
      pricePerKg: 48.0,
      mrpPrice: 65.0,
      unit: '1 pc (~2 kg)',
      availableQuantityKg: 50.0,
      source: 'Direct from Riverbed Farm',
      distanceKm: 6.0,
      qualityGrade: 'Grade A',
      iconEmoji: '🍉',
      rating: 4.8,
      ratingCount: 130,
      deliveryTime: '20-25 mins',
      harvestFreshness: 'Ultra Hydrating',
    ),
    const ConsumerProduct(
      id: 'c_prod_22',
      ...
      source: 'Direct from Telangana Groves',
      distanceKm: 4.8,
      qualityGrade: 'Carbide Free',
      iconEmoji: '🥭',
      rating: 5.0,
      ratingCount: 420,
      deliveryTime: '15-20 mins',
      isBestseller: true,
      harvestFreshness: 'Tree Ripened',
    ),
    ...
    const ConsumerProduct(
      ...
      distanceKm: 5.5,
      qualityGrade: 'Premium Aged',
      iconEmoji: '🍚',
      rating: 4.9,
      ratingCount: 195,
      deliveryTime: '20-25 mins',
      harvestFreshness: 'Aged 1 Year',
    ),
    const ConsumerProduct(
      id: 'c_prod_24',
      ...
      source: 'Direct from MP Farmer FPO',
      distanceKm: 5.8,
      qualityGrade: 'Chakki Fresh',
      iconEmoji: '🌾',
      rating: 4.9,
      ratingCount: 235,
      deliveryTime: '20-25 mins',
      harvestFreshness: '100% Whole Grain',
    ),
    const ConsumerProduct(
      id: 'c_prod_25',
      ...
      source: 'Direct from Gulbarga FPO',
      distanceKm: 6.0,
      qualityGrade: 'Native Variety',
      iconEmoji: '🫘',
      rating: 4.8,
      ratingCount: 140,
      deliveryTime: '20-25 mins',
      harvestFreshness: 'Rich Protein',
    ),
  ];
